package com.example.aion.alphamemo;
...
import com.example.aion.alphamemo.adapter.MemoListAdapter;
import com.example.aion.alphamemo.item.MemoItem;
...
public class MainActivity extends AppCompatActivity implements  View.OnClickListener {
    ...
    private void setRecyclerView() {
        ...
        memoListAdapter = new MemoListAdapter(context,
                R.layout.row_memo_item, new ArrayList());
    ...
    private ArrayList<MemoItem> getMemoDummyList() {
        ...
        MemoItem item1 = new MemoItem("chest",
                "Bench Press 255lbs 5 5 5 4");
        MemoItem item2 = new MemoItem("legs",
                "Low Bar Squats 315lbs 5 5 5 8");
